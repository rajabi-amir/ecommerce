                        ...
                        function (e) {
                            ...
                            $.post(
                                url,
                                {
                                    ...
                                    variation: $("#var-select").val(),
                                    qtybutton: $("#qtybutton").val(),
                                },
                                function (response, status, xhr) {
                                    if (xhr.status == 200) {
                                        ...
                                        if (
                                            $("#header-cart-count").html == null
                                        ) {
                                            $("#header-cart-count").value(1);
                                        } else {
                                        ...
                                        $(".products").append(
                                            '<div class="product product-cart" id=' +
                                                rowid +
                                                ">" +
                                                ...
                                                "-" +
                                                " " +
                                                response.cart[rowid].attributes
                                                    .value +
                                                "</smpn>" +
                                                "</a>" +
                                                '<div class="price-box">' +
                                                ...
                                                " </a>" +
                                                "</figure>" +
                                                '<button class="btn btn-link btn-close" onclick="return delete_product_cart(' +
                                                "'" +
                                                rowid.toString() +
                                                "'" +
                                                ')">' +
                                        ...
                                        $(".price").html(
                                            number_format(response.all_cart) +
                                                "تومان"
                                        );
                                                      ...
                                                      Wolmart.Minipopup.open({
                                                          ...
                                                          actionTemplate:
                                                              ...
                                                              window.location
                                                                  .origin +
                                                              "/cart" +
                                                              '" class="btn btn-rounded btn-sm">نمایش سبد</a>',
                                                      });
                                              }, 500));
                        ...
                        function (e) {
                            ...
                            $.get(url, function (response, status) {
                                ...
                                if (response.errors == "deleted") {
                                    ...
                                    $.notify(
                                        "کاربر گرامی ابتدا باید وارد شوید.",
                                        "warn",
                                        {
                                            position: "tap",
                                        }
        ...
        (QuantityInput.min = 1),
            ...
            (QuantityInput.prototype.init = function (t) {
                ...
                (e.$minus = !1),
                    ...
                    (e.$value = t.val(
                        (e.value = parseInt(t.val()) || QuantityInput.value)
                    )),
                    (e.$minus = t
                        .parent()
                        .find(".quantity-minus")
