    ...
    (function (t) {
        ...
        (Wolmart.$window = t(window)),
                ...
                return (
                                ...
                                ? ((this.height = o[0].offsetHeight),
                                  ...
                                  o.hasClass("fix-top")
                                      ? (o.css(
                                        ...
                                        (this.zIndex =
                                            this.options.max_index - a.index))
                    ...
                    function (a, i) {
                        Wolmart.$(a).each(function () {
                            var a = t(this);
                            a.data("sticky-content") ||
                                a.data("sticky-content", new e(a, i));
                        });
                    }
                );
            })()),
            ...
            (Wolmart.initPopup = function (e, a) {
                Wolmart.$body.hasClass("home") &&
                    ...
                    t(".sign-in").magnificPopup({
                        ...
                        callbacks: {
                            open: function () {
                                this.wrap.find('[href="#sign-in"]').click();
                            },
                        },
                    }),
                    t(".register").magnificPopup({
                        type: "inline",
                        midClick: true,
                        callbacks: {
                            open: function () {
            ...
            (Wolmart.minipopupOption = {
                ...
                space: 20,
                template:
                    '<div class="minipopup-box"><div class="product product-list-sm {{productClass}}"><figure class="product-media"><a href="{{imageLink}}"><img src="{{imageSrc}}" alt="محصول" width="80" height="90" /></a></figure><div class="product-details"><h4 class="product-name"><a href="{{nameLink}}">{{name}}</a></h4>{{message}}</div></div><div class="product-action">{{actionTemplate}}</div></div>',
            }),
            (Wolmart.Minipopup =
                ((a = 0),
                (i = []),
            ...
            (Slider.zoomImageRefresh = function () {
                this.$element.find("img").each(function () {
                    ...
                    if (t.fn.zoom) {
                        ...
                        void 0 !== a
                            ? a.refresh()
                            : ((Wolmart.zoomImageOptions.zoomContainer =
                                  e.parent()),
                              e.zoom(Wolmart.zoomImageOptions));
                    }
                });
            ...
            (Slider.prototype.init = function (l, c) {
                ...
                if (
                    ...
                    t.extend(
                        !0,
                        u,
                        Wolmart.parseOptions(l.attr("data-owl-options")),
                        c
                    ),
                    (o = o.bind(this)),
                    (s = s.bind(this)),
    ...
    (function (t) {
        var e = {
                ...
                Wolmart.call(Wolmart.ratingTooltip, 500),
                    ...
                    Wolmart.$body.on(
                        ...
                        function (e) {
                            ...
                            a.hasClass("disabled")
                                ? alert(
                                      "لطفاً قبل از افزودن این محصول به سبد خرید ، برخی از گزینه های محصول را انتخاب کنید."
                                  )
                                : (a
                                      .toggleClass("added")
                                  ...
                                  setTimeout(function () {
                                      a.removeClass(
                                          ...
                                          Wolmart.Minipopup.open({
                                              ...
                                              actionTemplate:
                                                  '<a href="cart.html" class="btn btn-rounded btn-sm">نمایش سبد</a><a href="checkout.html" class="btn btn-dark btn-rounded btn-sm">پرداخت</a>',
                                          });
                                  }, 500));
                        }
                    ),
                    ...
                    (e = t(".product-popup")).length &&
                        Wolmart.$body.on(
                            ...
                            function (a) {
                                ...
                                let images_value = JSON.parse(images);
                                let category_value = JSON.parse(category);
                                    ...
                                    Wolmart.popup(
                                        {
                                            ...
                                            callbacks: {
                                                open: function () {
                                                    ...
                                                    // ).html(category_value.name);

                                                    //محصول بند انگشتی
                                                    // images_value.forEach(
                                                    //     (value) => {
                                                    //         $(
                                                    //             ".product-thumbs"
                                                    //         ).each(function () {
                                                    ...
                                                    //                     src +
                                                    //                     " " +
                                                    //                     'alt="Product Thumb" width="103" id="id_images" height="116">' +
                                                    //                     "</div>"
                                                    //             );
                                                    //         });
                                                    //     }
                                                    // );
                                                    //محصول بند انگشتی پایان
                                                    ...
                                                    //                     src +
                                                    //                     " " +
                                                    //                     'alt="آب جوش ظروف سیاه" width="800" height="900"> </figure>'
                                                    //             );
                                                    //         });
                                                    //     }
                                                    // );
                    ...
                    (function () {
                        ...
                        i.length ||
                            ...
                            (t(".page-wrapper").append(
                                '<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">مقایسه محصولات</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">حذف همه</a>                        <a href="compare.html" class="btn btn-dark btn-rounded">شروع مقایسه !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'
                            ),
                            (i = t(".page-wrapper > .compare-popup"))),
                            Wolmart.$body
                                .on(
                                ...
                                .on(
                                    ...
                                    function (i) {
                                        i.preventDefault();
                                        var n = t(i.currentTarget).closest(
                                                "li"
                                            ),
                                            s = n.index(),
            ...
            initProductsScrollLoad: function (e) {
                ...
                var n = function (e) {
                    window.pageYOffset >
                        a + i.outerHeight() - window.innerHeight - 150 &&
    ...
    (function (t) {
        ...
        (ProductSingle.prototype.init = function (e) {
                    ...
                    .on("initialized.owl.carousel", function (e) {
                        document.body.classList.contains("home") ||
                            ...
                            l.parent().hasClass("product-gallery-video") &&
                                (r.isQuickView ||
                                    l.append(
                                        '<a href="#" class="product-gallery-btn product-degree-viewer" title="گالری محصول 360 درجه"><i class="w-icon-rotate-3d"></i></a>'
                                    ),
                                r.isQuickView ||
                                    l.append(
                                        '<a href="#" class="product-gallery-btn product-video-viewer" title="ویدئو تصویر کوچک محصول"><i class="w-icon-movie"></i></a>'
                                    ))),
                            (function (e) {
                                (e.$thumbs =
                                    e.$wrapper.find(".product-thumbs")),
                                    (e.$thumbsWrap = e.$thumbs.parent()),
                                    (e.$thumbUp =
                                        e.$thumbsWrap.find(".thumb-up")),
                                    (e.$thumbDown =
                                        e.$thumbsWrap.find(".thumb-down")),
            ...
            (ProductSingle.prototype.clickStickyThumbnail = function (e) {
                ...
                n.length &&
                    ((n = n.offset().top + 10), Wolmart.scrollTo(n, 500)),
                    setTimeout(function () {
            ...
            (ProductSingle.prototype.swatchImage = function () {
                var t = this.$items.find(".active img").attr("src"),
                    e = this.$wrapper.find(
                        ".owl-item:first-child .product-image img"
                    ),
                    a = this.$wrapper.find(
                        ".owl-item:first-child .product-thumb img"
                    );
            ...
            (Wolmart.productSingle = function (e) {
                return (
                    Wolmart.$(e).each(function () {
                        var e = t(this);
                        e.is("body > *") ||
                            e.data("product-single", new ProductSingle(e));
                    }),
                    null
                );
            });
        ...
        function e(e) {
            ...
            if (
                ...
                var s = n
                        ...
                        .data("owl.carousel"),
                    r = s
                        ? (s.current() - s.clones().length / 2 + i.length) %
                          i.length
                ...
                if (i.length)
                    ...
                    var o =
                        ...
                        a
                            ...
                            .find(".product-title")
                            .text() +
                        ' به سبد خرید شما اضافه شد.</p>                            <a href="#" class="btn btn-link btn-close"><i class="close-icon"></i></a>                            </div>';
        ...
        (Calendar.defaultOptions = {
            ...
            (Calendar.prototype.render = function (e, a) {
                ...
                for (var u = d; u < d + 7; u++) {
                    var p = t(
                        "<th>" +
                            this.settings.days[u % 7].substring(
                                0,
                                this.settings.dayExcerpt
                            ) +
                            "</th>"
                    );
            ...
            (Wolmart.initVendor = function (e) {
                ...
                i.on("click", function (t) {
                    ...
                    o.on("click", function () {
                        alert(
                            "همیشه این نوع پیوندها را در برنامه مرتبط باز کنید"
                        );
                    });
            }),
