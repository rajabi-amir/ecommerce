...
(function (factory) {
    ...
    $h = {
        ...
        getFileId: function (file, generateFileId) {
            ...
            return (
                file.size +
                "_" +
                encodeURIComponent(relativePath).replace(/%/g, "_")
            );
        },
        ...
        cspBuffer: {
            ...
            apply: function (domElement) {
                var self = this,
                    $el = $(domElement);
                $el.find("[" + self.CSP_ATTRIB + "]").each(function (
                    key,
                    elem
                ) {
                    var $elem = $(elem),
    ...
    FileInput.prototype = {
        ...
        _init: function (options, refreshMode) {
            ...
            self.progressInfoTemplate = t.replace(
                "{class}",
                self.progressInfoClass
            );
            ...
            self.$captionIcon =
                self.$captionContainer.find(".file-caption-icon");
            ...
            rm = self.resumableManager = {
                ...
                setProcessed: function (status) {
                    ...
                    if (status === "success") {
                        ...
                        if (self.showPreview) {
                            ...
                            self._initUploadSuccess(
                                rm.chunksProcessed[id].data,
                                $thumb
                            );
                        }
                        fm.removeFile(id);
                        ...
                        if (status !== "cancel") {
                            ...
                            if (
                                ...
                                msg =
                                    self.msgResumableUploadRetriesExceeded.setTokens(
                                        tokens
                                    );
                ...
                upload: function () {
                    ...
                    intervalId = setInterval(function () {
                        ...
                        if (fm.isProcessed()) {
                            var $initThumbs = self.$preview.find(
                ...
                processUpload: function () {
                    ...
                    fnBefore = function (jqXHR) {
                        ...
                        self._raise("filetestbeforesend", [
                            id,
                            fm,
                            rm,
                            outData,
                    ...
                    fnSuccess = function (data, textStatus, jqXHR) {
                        ...
                        var pNames = self.uploadParamNames,
                            chunksUploaded =
                                pNames.chunksUploaded || "chunksUploaded",
                            params = [id, fm, rm, outData];
                        if (
                            !data[chunksUploaded] ||
                            !$h.isArray(data[chunksUploaded])
                        ) {
        ...
        _initPreviewCache: function () {
            ...
            self.previewCache = {
                ...
                count: function (skipNull) {
                    ...
                    if (skipNull) {
                        var chk = self.previewCache.data.content.filter(
                            function (n) {
                                return n !== null;
                            }
                        );
                ...
                get: function (i, isDisabled) {
                    ...
                    if (!$h.isEmpty(config) && !$h.isEmpty(config.frameAttr)) {
                        ...
                        $tmp.find(".file-preview-initial").attr(
                            config.frameAttr
                        );
                        out = $tmp.html();
                        $tmp.remove();
        ...
        _resetErrors: function (fade) {
            ...
            if (
                ...
                (self.enableResumableUpload && history)
            ) {
                return;
            }
            self.isError = false;
        ...
        _zoneDrop: function (e) {
            ...
            if (
                !self._raise("fileDragDrop", { sourceEvent: e, files: files })
            ) {
                return;
            }
            if (folders > 0) {
        ...
        _initAjaxSettings: function () {
            ...
            self._ajaxDeleteSettings = $.extend(
                true,
                {},
        ...
        _ajaxSubmit: function (
            ...
            formdata.append(
                "initialPreview",
                JSON.stringify(self.initialPreview)
            );
            formdata.append(
        ...
        _initSuccessThumbs: function () {
            ...
            setTimeout(function () {
                self._getThumbs($h.FRAMES + ".file-preview-success").each(
                    function () {
                        var $thumb = $(this),
        ...
        _uploadSingle: function (i, id, isBatch, deferrer) {
            var self = this,
                ...
                $btnDelete,
                hasPostData =
                    count > 0 || !$.isEmptyObject(self.uploadExtraData),
                uploadFailed,
                $prog,
                fnBefore,
                errMsg,
        ...
        _uploadBatch: function () {
            var self = this,
                ...
                fnComplete,
                hasPostData =
                    total > 0 || !$.isEmptyObject(self.uploadExtraData),
                errMsg,
                setAllUploaded,
                formdata = new FormData(),
        ...
        _deleteFileIndex: function ($frame) {
            ...
            if (ind.substring(0, 5) === $h.INIT_FLAG) {
                ...
                self.initialPreview = $h.spliceArray(
                    self.initialPreview,
                    ind,
                    rev
                );
        ...
        _resetCaption: function () {
            ...
            setTimeout(function () {
                var cap = "",
                    ...
                    cfg,
                    hasThumb =
                        self.showPreview && self.getFrames(incomplete).length;
        ...
        _initFileActions: function () {
            ...
            self.getFrames(" .kv-file-upload").each(function () {
                ...
                self._handler($el, "click", function () {
                    ...
                    self._uploadSingle(
                        self.fileManager.getIndex(fileId),
                        fileId,
                        false
                    );
                });
            ...
            $preview.find(btnRemove).each(function () {
                ...
                extraData =
                    $h.isEmpty(config) || $h.isEmpty(config.extra)
                        ...
                        : config.extra;
                fileName =
                    (config && (config.filename || config.caption)) || "";
                ...
                fnSuccess = function (data, textStatus, jqXHR) {
                    ...
                    if (!$h.isEmpty(data) && !$h.isEmpty(data.error)) {
                        ...
                        $el.removeClass("disabled " + origClass).addClass(
                            errClass
                        );
                        resetProgress();
                        return;
        ...
        _generatePreviewTemplate: function (
            ...
            var self = this,
                ...
                footer =
                    foot ||
                    self._renderFileFooter(cat, caption, size, "auto", isError),
            ...
            getContent = function (vCat, vData, zoom, frameCss, vZoomData) {
                ...
                if (cat === "object" && !ftype) {
                    $.each(
                        self.defaults.fileTypeSettings,
                        function (key, func) {
        ...
        _updateFileDetails: function (numFiles) {
            ...
            log =
                n === 1
                    ? label
                    : self._getMsgSelected(
                          nFiles,
                          !self.isAjaxUpload && !self.isError
                      );
            if (self.isError) {
            ...
            pendingTime =
                !stats.elapsed || !stats.bps
                    ...
                    : self.msgPendingTime.setTokens({
                          time: $h.getElapsed(
                              Math.ceil(stats.pendingBytes / stats.bps)
                          ),
                      });
        ...
        _getFileCount: function (fileCount, includeInitial) {
            ...
            if (includeInitial === undefined) {
                includeInitial =
                    self.validateInitialCount && !self.overwriteInitial;
            }
            if (includeInitial) {
        ...
        _setPreviewError: function ($thumb, keepFile) {
            var self = this,
                removeFrame =
                    self.removeFromPreviewOnError && !self.retryErrorUploads;
        ...
        setImageOrientation: function ($img, $zoomImg, value, $thumb) {
            var self = this,
                ...
                zoomOnly =
                    invalidImg &&
                    $thumb &&
                    $thumb.attr("data-template") === "image",
                ev;
        ...
        _validateImageOrientation: function (
            ...
            if (self.canOrientImage) {
                $img.css(
                    "image-orientation",
                    autoOrientImage ? "from-image" : "none"
                );
                self._validateImage(
                    previewId,
                    fileId,
        ...
        _createContainer: function () {
            var self = this,
                ...
                $container = $h.createElement(
                    $h.cspBuffer.stash(self._renderMain())
                );
        ...
        _change: function (e) {
            ...
            var $el = self.$element,
                ...
                maxCountCheck = function (n, m, all) {
                    var msg = all
                        ? self.msgTotalFilesTooMany
                        : self.msgFilesTooMany;
            ...
            if (maxCount > 0 && total > maxCount) {
                ...
                if (inclAll) {
                    ...
                    if (maxTotCount > 0 && total > maxTotCount) {
                        if (!self.autoReplace || len > maxCount) {
                            maxCountCheck(
                                self.autoReplace && len > maxTotCount
                                    ? len
                                    : total,
                                maxTotCount,
                                true
        ...
        _canPreview: function (file) {
            ...
            return (
                !skipPreview && (allowedTypes || allowedMimes || allowedExts)
            );
        },
            ...
            readFile = function (i) {
                ...
                if (i >= numFiles) {
                    ...
                    if (self.duplicateErrors.length) {
                        errors =
                            "<li>" +
                            self.duplicateErrors.join("</li><li>") +
                            "</li>";
                        if ($error.find("ul").length === 0) {
                            $h.setHtml(
                                $error,
                                self.errorCloseButton +
                                    "<ul>" +
                                    errors +
                                    "</ul>"
                            );
                ...
                if (self.maxFileSize > 0 && fileSize > self.maxFileSize) {
                    msg = self.msgSizeTooLarge.setTokens({
                        name: caption,
                        size: sizeHuman,
                        maxSize: self._getSize(
                            self.maxFileSize * self.bytesToKB,
                            true
                        ),
                    });
                    throwError(msg, file, previewId, i, fileId);
                ...
                if (
                    ...
                    msg = self.msgSizeTooSmall.setTokens({
                        name: caption,
                        size: sizeHuman,
                        minSize: self._getSize(
                            self.minFileSize * self.bytesToKB,
                            true
                        ),
                    });
                    throwError(msg, file, previewId, i, fileId);
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgFilesTooLess: "شما میتوانید حد اکثر  <b>{n}</b> تصویر آپلود کنید.",
        msgFilesTooMany:
        ...
        msgInvalidFileExtension:
            'پسوند نامعتبر برای فایل "{name}". فقط "{extensions}" پستیبانی میشود.',
        msgFileTypes: {
            image: "تصویر",
            html: "HTML",
            text: "text",
        ...
        dropZoneTitle: "فایل را در اینجا بکشید و رها کنید  &hellip;",
