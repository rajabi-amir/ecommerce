        ...
        <div class="tab-content">
            <div class="tab-pane active" id="main-menu">
                <ul class="mobile-menu">
                    <li><a href="demo5.html">صفحه اصلی </a></li>
                    <li>
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="shop-horizontal-filter.html">فیلتر افقی<span class="tip tip-hot">داغ
                                            </span></a></li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="product-default.html">پیشفرض <span class="tip tip-hot">داغ </span></a>
                                    </li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="vendor-wcfm-store-product-grid.html">فروشنده 2</a></li>
