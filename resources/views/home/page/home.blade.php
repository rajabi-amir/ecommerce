                        ...
                        <div class="intro-slide intro-slide2 banner banner-fixed br-sm" style="background-image: url(assets/images/demos/demo5/slides/slide-2.jpg); background-color: #EBEDEC;">
                            <div class="banner-content y-50">
                                <div class="slide-animate" data-animation-options="{
                                    ...
                                    <h5 class="banner-subtitle text-uppercase text-primary ls-25">محصولات جدید
                                    </h5>
                                    <h3 class="banner-title text-capitalize ls-25 mb-0">مدل مردانه </h3>
                                    <div class="banner-price-info text-default font-weight-bold mb-6 ls-50">
                                        شروع از <span class="text-secondary">120000 تومان</span>
                                    </div>
                        ...
                        <div class="intro-slide intro-slide3 banner banner-fixed br-sm" style="background-image: url(assets/images/demos/demo5/slides/slide-3.jpg); background-color: #E0E0DE;">
                            <div class="banner-content text-right y-50">
                                <div class="slide-animate" data-animation-options="{
                                    ...
                                    <h5 class="banner-subtitle text-primary text-uppercase">فروشنده ها </h5>
                                    <h3 class="banner-title text-capitalize lh-1 ls-25">کفش ورزشی جدید <br>مجموعه </h3>
                                    <div class="banner-price-info text-uppercase text-default">
                                        <strong class="text-dark">ذخیره تا 10%</strong> تخفیف
                                    </div>
                                    <a href="shop-banner-sidebar.html" class="btn btn-dark btn-rounded">اکنون بخرید </a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 col-xs-6 mb-4">
                            <div class="category-banner banner banner-fixed br-sm">
                                ...
                                <div class="banner-content">
                                    ...
                                    <h5 class="banner-subtitle text-white text-capitalize ls-25">انواع تخفیف تا </h5>
                                    <div class="banner-price-info text-white text-uppercase ls-25">25% تخفیف </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-xs-6 mb-4">
                            <div class="category-banner banner banner-fixed br-sm">
                                ...
                                <div class="banner-content">
                                    <h3 class="banner-title text-white text-capitalize ls-25 mb-3">بهترین حراج <br>برای
                                        یوگا </h3>
                                    <del class="old-price text-white ls-25">489000 تومان</del>
        ...
        <div class="row cols-md-4 cols-sm-3 cols-1 icon-box-wrapper  br-sm bg-white" data-owl-options="{
            ...
            <div class="icon-box icon-box-side text-dark">
                ...
                <div class="icon-box-content">
                    <h4 class="icon-box-title font-weight-bolder ls-normal">ارسال و عودت رایگان</h4>
            ...
            <div class="icon-box icon-box-side text-dark">
                ...
                <div class="icon-box-content">
                    <h4 class="icon-box-title font-weight-bolder ls-normal">پرداخت ایمن </h4>
            ...
            <div class="icon-box icon-box-side text-dark icon-box-money">
                ...
                <div class="icon-box-content">
                    <h4 class="icon-box-title font-weight-bolder ls-normal">تضمین بازگشت پول</h4>
            ...
            <div class="icon-box icon-box-side text-dark icon-box-chat">
                ...
                <div class="icon-box-content">
                    <h4 class="icon-box-title font-weight-bolder ls-normal">پشتیبانی مشتری</h4>
        ...
        <div class="owl-carousel owl-theme appear-animate row cols-lg-5 cols-md-4 cols-sm-3 cols-2 mb-6" data-owl-options="{
            ...
            <div class="product-wrap">
                <div class="product text-center">
                    ...
                    <div class="product-details">
                        <h4 class="product-name"><a href="product-default.html">ساعت چرمی بند</a></h4>
                        ...
                        <div class="product-price">
                            <ins class="new-price">189000 تومان </ins><del class="old-price">199000 تومان </del>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="product-wrap">
                <div class="product text-center">
                    ...
                    <div class="product-details">
                        ...
                        <div class="product-price">
                            <ins class="new-price">27000 تومان</ins><del class="old-price">289000 تومان</del>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="product-wrap">
                <div class="product text-center">
                    ...
                    <div class="product-details">
                        <h4 class="product-name"><a href="product-default.html">کفش های ورزشی تابستانی</a></h4>
                        <div class="ratings-container">
                            <div class="ratings-full">
                                <span class="ratings" style="width: 100%;"></span>
                                <span class="tooltiptext tooltip-top"></span>
                        ...
                        <div class="product-price">
                            <ins class="new-price">54000 تومان</ins><del class="old-price">64000 تومان</del>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="product-wrap">
                <div class="product text-center">
                    ...
                    <div class="product-details">
                        ...
                        <div class="product-price">
                            <ins class="new-price">34000 تومان</ins><del class="old-price">49000 تومان</del>
                        </div>
                    </div>
                </div>
            </div>
