                            ...
                            if ((g++, !f.hasClass("bs-title-option"))) {
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        var B =
                                            l.eq(k)[0].previousElementSibling;
                                        B &&
                                            "OPTGROUP" === B.tagName &&
                                            !B.disabled &&
                                            (A = !0);
                        ...
                        if ((y(), "auto" === this.options.size)) {
                            var z = function () {
                                var m,
                                    ...
                                    u =
                                        j.$menuInner[0].getElementsByTagName(
                                            "li"
                                        ),
                ...
                keydown: function (b) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            /(32)/.test(b.keyCode.toString(10)) ||
                                (i.$menuInner.find(".active a").click(),
                                g.focus());
                        else {
                            var o = a(":focus");
                            o.click(),
                    ...
                    this.each(function () {
                        ...
                        function e(a, b, c) {
                            ...
                            if (
                                ...
                                (o =
                                    parseInt(z.css("top")) /
                                    (u.outerHeight() - z.outerHeight())),
                                (e = o * (u[0].scrollHeight - u.outerHeight())),
                                c)
                            ) {
                                e = a;
                                var i =
                                    (e / u[0].scrollHeight) * u.outerHeight();
                        ...
                        function f() {
                            (n = Math.max(
                                (u.outerHeight() / u[0].scrollHeight) *
                                    u.outerHeight(),
                                r
                            )),
                                z.css({
                        ...
                        if (u.parent().hasClass(d.wrapperClass)) {
                            ...
                            if (
                                ...
                                if ("scrollTo" in b) v = parseInt(d.scrollTo);
                                    ...
                                    return (
                                        z.remove(), y.remove(), void u.unwrap()
                                    );
                                e(v, !1, !0);
                            }
        ...
        var k = k || {},
            ...
            q = {
                ...
                allowEvent: function (a) {
                    var b = !0;
                    return (
                        /^(mousedown|mousemove)$/.test(a.type) &&
                            q.touches &&
                            (b = !1),
                        b
                    );
