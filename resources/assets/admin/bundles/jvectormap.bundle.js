!(function (a) {
    ...
    a.fn.vectorMap = function (a) {
        var c,
            d,
            c = this.children(".jvectormap-container").data("mapObject");
        if ("addMap" === a) jvm.Map.maps[arguments[1]] = arguments[2];
        else {
            if (("set" === a || "get" === a) && b[a][arguments[1]])
                return (
                    (d =
    ...
    (function (a) {
        ...
        function b(b) {
            ...
            if (
                ...
                "axis" in g &&
                    ...
                    ((k = -1 * l), (l = 0)),
                (j = 0 === l ? k : l),
                "deltaY" in g && ((l = -1 * g.deltaY), (j = l)),
                "deltaX" in g && ((k = g.deltaX), 0 === l && (j = -1 * k)),
                0 !== l || 0 !== k)
            ) {
                if (1 === g.deltaMode) {
                ...
                return (
                    (m = Math.max(Math.abs(l), Math.abs(k))),
                    (!f || f > m) && ((f = m), d(g, m) && (f /= 40)),
                    d(g, m) && ((j /= 40), (k /= 40), (l /= 40)),
        ...
        var k = (a.event.special.mousewheel = {
            ...
            getLineHeight: function (b) {
                return parseInt(
                    a(b)
                        ["offsetParent" in a.fn ? "offsetParent" : "parent"]()
                        .css("fontSize"),
                    10
                );
            },
...
var jvm = {
    ...
    mixin: function (a, b) {
        ...
        for (c in b.prototype)
            b.prototype.hasOwnProperty(c) && (a.prototype[c] = b.prototype[c]);
    },
    min: function (a) {
        var b,
            c = Number.MAX_VALUE;
...
(jvm.$ = jQuery),
    ...
    (jvm.AbstractCanvasElement.prototype.addGroup = function (a) {
        ...
        return (
            a ? a.node.appendChild(b.node) : this.node.appendChild(b.node),
            (b.canvas = this),
            b
        );
    }),
    ...
    (jvm.AbstractShapeElement.prototype.updateStyle = function () {
        ...
        jvm.AbstractShapeElement.mergeStyles(a, this.style.initial),
            ...
            this.isHovered &&
                jvm.AbstractShapeElement.mergeStyles(a, this.style.hover),
            this.isSelected &&
                (jvm.AbstractShapeElement.mergeStyles(a, this.style.selected),
                this.isHovered &&
    ...
    (jvm.SVGShapeElement.prototype.applyAttr = function (a, b) {
        var c,
            d,
            e = this;
        "fill" === a && jvm.isImageUrl(b)
            ? jvm.SVGShapeElement.images[b]
                ? this.applyAttr(
                      "fill",
                      "url(#image" + jvm.SVGShapeElement.images[b] + ")"
                  )
                : jvm.whenImageLoaded(b).then(function (a) {
                      (d = new jvm.SVGElement("image")),
                          ...
                          d.applyAttr("x", "0"),
                          d.applyAttr("y", "0"),
                          d.applyAttr("width", a[0].width),
                          d.applyAttr("height", a[0].height),
                          (c = new jvm.SVGElement("pattern")),
                          c.applyAttr(
                              "id",
                          ...
                          c.applyAttr("x", 0),
                          c.applyAttr("y", 0),
                          c.applyAttr("width", a[0].width / 2),
                          c.applyAttr("height", a[0].height / 2),
                          c.applyAttr(
                              "viewBox",
                              "0 0 " + a[0].width + " " + a[0].height
                          ),
                          c.applyAttr("patternUnits", "userSpaceOnUse"),
                          c.node.appendChild(d.node),
                          e.canvas.defsElement.node.appendChild(c.node),
                          (jvm.SVGShapeElement.images[b] = jvm.SVGShapeElement
                              .imageCounter++),
                          e.applyAttr(
                              "fill",
                              "url(#image" + jvm.SVGShapeElement.images[b] + ")"
    ...
    (jvm.SVGImageElement = function (a, b) {
        jvm.SVGImageElement.parentClass.call(this, "image", a, b);
    }),
    jvm.inherits(jvm.SVGImageElement, jvm.SVGShapeElement),
    (jvm.SVGImageElement.prototype.applyAttr = function (a, b) {
        var c = this;
        "image" == a
            ? jvm.whenImageLoaded(b).then(function (a) {
                  c.node.setAttributeNS(
                      ...
                      (c.width = a[0].width),
                      (c.height = a[0].height),
                      c.applyAttr("width", c.width),
                      c.applyAttr("height", c.height),
                      c.applyAttr("x", c.cx - c.width / 2),
                      c.applyAttr("y", c.cy - c.height / 2),
                      jvm.$(c.node).trigger("imageloaded", [a]);
              })
            : "cx" == a
            ? ((this.cx = b),
              this.width && this.applyAttr("x", b - this.width / 2))
            : "cy" == a
            ? ((this.cy = b),
              this.height && this.applyAttr("y", b - this.height / 2))
    ...
    (jvm.SVGTextElement.prototype.applyAttr = function (a, b) {
        "text" === a
            ? (this.node.textContent = b)
    ...
    (jvm.VMLShapeElement.prototype.applyAttr = function (a, b) {
        switch (a) {
            ...
            case "stroke-opacity":
                ...
                break;
            case "stroke-width":
                (this.node.stroked = 0 !== parseInt(b, 10)),
                ...
                .replace(
                    ...
                    function (a, f, g) {
                        ...
                        for (var h = 0, i = g.length; i > h; h++)
                            g[h] = Math.round(100 * g[h]);
                        switch (f) {
                            case "m":
                                return (
                                    (d += g[0]), (e += g[1]), "t" + g.join(",")
                                );
                            case "M":
                                return (
                                    (d = g[0]), (e = g[1]), "m" + g.join(",")
                                );
                            case "l":
                                return (
                                    (d += g[0]), (e += g[1]), "r" + g.join(",")
                                );
                            case "L":
                                return (
                                    (d = g[0]), (e = g[1]), "l" + g.join(",")
                                );
                            case "h":
    ...
    (jvm.VectorCanvas = function (a, b, c) {
        return (
            ...
            (this.impl =
                "svg" == this.mode
                    ? new jvm.SVGCanvasElement(a, b, c)
                    : new jvm.VMLCanvasElement(a, b, c)),
    ...
    (jvm.OrdinalScale.prototype.getTicks = function () {
        var a,
            b = [];
        for (a in this.scale) b.push({ label: a, value: this.scale[a] });
        return b;
    }),
    (jvm.NumericScale = function (a, b, c, d) {
        (this.scale = []),
            ...
            void 0 !== c && this.setMin(c),
            void 0 !== d && this.setMax(d);
    }),
    (jvm.NumericScale.prototype = {
        ...
        setScale: function (a) {
            var b;
            for (this.scale = [], b = 0; b < a.length; b++)
                this.scale[b] = [a[b]];
        },
        ...
        getValue: function (a) {
            ...
            for (
                "function" == typeof this.normalize && (a = this.normalize(a)),
                    f = 0;
                f < this.scale.length - 1;
                f++
            )
                (b = this.vectorLength(
                    this.vectorSubtract(this.scale[f + 1], this.scale[f])
                )),
                    d.push(b),
                    (e += b);
            for (
                c = (this.maxValue - this.minValue) / e, f = 0;
                f < d.length;
                f++
            )
                d[f] *= c;
            for (f = 0, a -= this.minValue; a - d[f] >= 0; ) (a -= d[f]), f++;
            return (a = this.vectorToNum(
                f == this.scale.length - 1
                    ? this.scale[f]
                    : this.vectorAdd(
                          this.scale[f],
        ...
        vectorToNum: function (a) {
            ...
            for (b = 0; b < a.length; b++)
                c += Math.round(a[b]) * Math.pow(256, a.length - b - 1);
            return c;
        },
        ...
        getTicks: function () {
            var a,
                b,
                c = [this.clearMinValue, this.clearMaxValue],
                d = c[1] - c[0],
            ...
            for (
                0.15 >= f
                    ...
                    ? (e *= 5)
                    : 0.75 >= f && (e *= 2),
                    c[0] = Math.floor(c[0] / e) * e,
                    c[1] = Math.ceil(c[1] / e) * e,
                    a = c[0];
                a <= c[1];
                ...
                (b =
                    a == c[0]
                        ...
                        ? this.clearMaxValue
                        : a),
                    g.push({ label: a, value: this.getValue(b) }),
                    (a += e);
            return g;
        },
    }),
    ...
    (jvm.ColorScale.prototype.getValue = function (a) {
        return jvm.ColorScale.numToRgb(
            jvm.ColorScale.parentClass.prototype.getValue.call(this, a)
        );
    }),
    (jvm.ColorScale.arrayToRgb = function (a) {
        ...
        for (c = 0; c < a.length; c++)
            (b = a[c].toString(16)), (d += 1 == b.length ? "0" + b : b);
        return d;
    }),
    ...
    (jvm.Legend.prototype.render = function () {
        ...
        for (
            ...
            switch (
                ((b = jvm.$("<div/>").addClass("jvectormap-legend-tick")),
                (c = jvm.$("<div/>").addClass("jvectormap-legend-tick-sample")),
                this.series.params.attribute)
            ) {
                case "fill":
                    jvm.isImageUrl(e[a].value)
                        ? c.css("background", "url(" + e[a].value + ")")
            ...
            b.append(c),
                (d = e[a].label),
                this.params.labelRender && (d = this.params.labelRender(d)),
                b.append(
                    jvm
                        .$("<div>" + d + " </div>")
    ...
    (jvm.DataSeries = function (a, b, c) {
        ...
        (a = a || {}),
            ...
            jvm.$.isArray(a.scale)
                ? ((d =
                      "fill" === a.attribute || "stroke" === a.attribute
                          ? jvm.ColorScale
                          : jvm.NumericScale),
                  (this.scale = new d(
                      a.scale,
                ...
                : (this.scale = a.scale
                      ? new jvm.OrdinalScale(a.scale)
                      : new jvm.SimpleScale(a.scale)),
    ...
    (jvm.DataSeries.prototype = {
        setAttributes: function (a, b) {
            ...
            if ("string" == typeof a)
                ...
                for (c in d)
                    this.elements[c] &&
                        this.elements[c].element.setStyle(
        ...
        setValues: function (a) {
            ...
            if (
                ...
                for (c in a)
                    f[c] = a[c]
                        ? this.scale.getValue(a[c])
                        : this.elements[c].element.style.initial[
                              this.params.attribute
                          ];
            else {
                ...
                void 0 === this.params.min
                    ? (this.scale.setMin(e), (this.params.min = e))
                    : this.scale.setMin(this.params.min),
                    void 0 === this.params.max
                        ? (this.scale.setMax(d), (this.params.max = d))
        ...
        clear: function () {
            ...
            for (a in this.values)
                this.elements[a] &&
                    (b[a] =
                        this.elements[a].element.shape.style.initial[
                            this.params.attribute
                        ]);
    ...
    (jvm.Proj = {
        ...
        mill: function (a, b, c) {
            return {
                ...
                y:
                    (-this.radius *
                        Math.log(Math.tan((45 + 0.4 * a) * this.radDeg))) /
                    0.8,
            };
        },
        mill_inv: function (a, b, c) {
            return {
                lat:
                    (2.5 * Math.atan(Math.exp((0.8 * b) / this.radius)) -
                        (5 * Math.PI) / 8) *
                    this.degRad,
        ...
        merc: function (a, b, c) {
            return {
                ...
                y:
                    -this.radius *
                    Math.log(Math.tan(Math.PI / 4 + (a * Math.PI) / 360)),
            };
        },
        merc_inv: function (a, b, c) {
            return {
                lat:
                    (2 * Math.atan(Math.exp(b / this.radius)) - Math.PI / 2) *
                    this.degRad,
                lng: (c * this.radDeg + a / this.radius) * this.degRad,
            };
        },
        ...
        lcc: function (a, b, c) {
            var d = c * this.radDeg,
                ...
                h = a * this.radDeg,
                i =
                    Math.log(Math.cos(f) * (1 / Math.cos(g))) /
                    Math.log(
                        Math.tan(Math.PI / 4 + g / 2) *
                            (1 / Math.tan(Math.PI / 4 + f / 2))
                    ),
                j =
                    (Math.cos(f) * Math.pow(Math.tan(Math.PI / 4 + f / 2), i)) /
                    i,
        ...
        lcc_inv: function (a, b, c) {
            var d = a / this.radius,
                ...
                h = 45 * this.radDeg,
                i =
                    Math.log(Math.cos(g) * (1 / Math.cos(h))) /
                    Math.log(
                        Math.tan(Math.PI / 4 + h / 2) *
                            (1 / Math.tan(Math.PI / 4 + g / 2))
                    ),
                j =
                    (Math.cos(g) * Math.pow(Math.tan(Math.PI / 4 + g / 2), i)) /
                    i,
            ...
            return {
                lat:
                    (2 * Math.atan(Math.pow(j / l, 1 / i)) - Math.PI / 2) *
                    this.degRad,
                lng: (f + m / i) * this.degRad,
            };
        },
    ...
    (jvm.MapObject.prototype.getLabelText = function (a) {
        return this.config.label
            ? "function" == typeof this.config.label.render
                ? this.config.label.render(a)
                : a
            : null;
    }),
    ...
    (jvm.MapObject.prototype.setHovered = function (a) {
        this.isHovered !== a &&
            ((this.isHovered = a),
            (this.shape.isHovered = a),
            this.shape.updateStyle(),
            this.label &&
                ((this.label.isHovered = a), this.label.updateStyle()));
    }),
    (jvm.MapObject.prototype.setSelected = function (a) {
        this.isSelected !== a &&
            ((this.isSelected = a),
            (this.shape.isSelected = a),
            this.shape.updateStyle(),
            this.label &&
                ((this.label.isSelected = a), this.label.updateStyle()),
            jvm.$(this.shape).trigger("selected", [a]));
    }),
    ...
    (jvm.Region = function (a) {
        ...
        (this.config = a),
            ...
            (this.shape = a.canvas.addPath(
                { d: a.path, "data-code": a.code },
                a.style,
                a.canvas.rootElement
            )),
            this.shape.addClass("jvectormap-region jvectormap-element"),
            (b = this.shape.getBBox()),
            (c = this.getLabelText(a.code)),
            this.config.label &&
                c &&
                ((d = this.getLabelOffsets(a.code)),
                (this.labelX = b.x + b.width / 2 + d[0]),
                (this.labelY = b.y + b.height / 2 + d[1]),
                (this.label = a.canvas.addText(
                    {
                        text: c,
                        "text-anchor": "middle",
    ...
    (jvm.Marker = function (a) {
        ...
        (this.config = a),
            ...
            this.createShape(),
            (b = this.getLabelText(a.index)),
            this.config.label &&
                b &&
                ((this.offsets = this.getLabelOffsets(a.index)),
                (this.labelX = a.cx / this.map.scale - this.map.transX),
                (this.labelY = a.cy / this.map.scale - this.map.transY),
                (this.label = a.canvas.addText(
                    {
                        text: b,
                        "data-index": a.index,
    ...
    (jvm.Marker.prototype.setStyle = function (a) {
        ...
        jvm.Marker.parentClass.prototype.setStyle.apply(this, arguments),
            "r" === a && this.updateLabelPosition(),
            (b = !!this.shape.get("image")) != this.isImage &&
                ((this.isImage = b),
    ...
    (jvm.Map = function (a) {
        var b,
            c = this;
        if (
            ((this.params = jvm.$.extend(!0, {}, jvm.Map.defaultParams, a)),
        ...
        for (b in jvm.Map.apiEvents)
            this.params[b] &&
                this.container.bind(
                    jvm.Map.apiEvents[b] + ".jvectormap",
                    this.params[b]
                );
    ...
    (jvm.Map.prototype = {
        ...
        bindContainerEvents: function () {
            ...
            this.params.panOnDrag &&
                ...
                this.params.zoomOnScroll &&
                    this.container.mousewheel(function (a) {
                        var b = jvm.$(d.container).offset(),
                            c = a.pageX - b.left,
                            e = a.pageY - b.top,
                            f = Math.pow(
                                1 + d.params.zoomOnScrollSpeed / 1e3,
                                a.deltaFactor * a.deltaY
                            );
                        d.tip.hide(),
                            d.setScale(d.scale * f, c, e),
                            a.preventDefault();
                    });
        },
        bindContainerTouchEvents: function () {
            var a,
                ...
                i = function (i) {
                    ...
                    "touchstart" == i.type && (g = 0),
                        1 == n.length
                            ? (1 == g &&
                                  ((l = h.transX),
                                  (m = h.transY),
                                  (h.transX -= (c - n[0].pageX) / h.scale),
                                  (h.transY -= (d - n[0].pageY) / h.scale),
                                  h.applyTransform(),
                                  h.tip.hide(),
                                  (l != h.transX || m != h.transY) &&
                                      i.preventDefault()),
                              (c = n[0].pageX),
                              (d = n[0].pageY))
                            : 2 == n.length &&
        ...
        bindContainerPointerEvents: function () {
            var a = this,
                ...
                e = function (b) {
                    var c, d;
                    (0 != b.translationX || 0 != b.translationY) &&
                        ((c = a.transX),
                        (d = a.transY),
                        (a.transX += b.translationX / a.scale),
                        (a.transY += b.translationY / a.scale),
                        a.applyTransform(),
                        a.tip.hide(),
                        (c != a.transX || d != a.transY) && b.preventDefault()),
                        1 != b.scale &&
                            (a.setScale(
                                a.scale * b.scale,
                                b.offsetX,
            ...
            (b.target = c),
                c.addEventListener("MSGestureChange", e, !1),
        ...
        bindElementEvents: function () {
            ...
            this.container.mousemove(function (d) {
                ...
                this.container.delegate(
                    ...
                    function (a) {
                        var b =
                                ...
                                jvm.$(this).attr("class"),
                            c =
                                -1 === b.indexOf("jvectormap-region")
                                    ? "marker"
                                    : "region",
                            e = jvm
                                .$(this)
                                .attr(
                                    "region" == c ? "data-code" : "data-index"
                                ),
                            f =
                                "region" == c
                                    ? d.regions[e].element
                            ...
                            g =
                                "region" == c
                                    ? d.mapData.paths[e].name
                                    : d.markers[e].config.name || "",
                            h = jvm.$.Event(c + "TipShow.jvectormap"),
                            i = jvm.$.Event(c + "Over.jvectormap");
                        "mouseover" == a.type
                            ? (d.container.trigger(i, [e]),
                              i.isDefaultPrevented() || f.setHovered(!0),
                              d.tip.text(g),
                              d.container.trigger(h, [d.tip, e]),
                              h.isDefaultPrevented() ||
                                  (d.tip.show(),
                                  (d.tipWidth = d.tip.width()),
                                  (d.tipHeight = d.tip.height())))
                            : (f.setHovered(!1),
                              d.tip.hide(),
                              d.container.trigger(c + "Out.jvectormap", [e]));
                    }
                ),
                this.container.delegate(
                    "[class~='jvectormap-element']",
                ...
                this.container.delegate(
                    ...
                    "mouseup",
                    function () {
                        var a = jvm.$(this).attr("class").baseVal
                                ? jvm.$(this).attr("class").baseVal
                                : jvm.$(this).attr("class"),
                            b =
                                -1 === a.indexOf("jvectormap-region")
                                    ? "marker"
                                    : "region",
                            e = jvm
                                .$(this)
                                .attr(
                                    "region" == b ? "data-code" : "data-index"
                                ),
                            ...
                            g =
                                "region" == b
                                    ...
                                    : d.markers[e].element;
                        c ||
                            (d.container.trigger(f, [e]),
                            (("region" === b && d.params.regionsSelectable) ||
                                ("marker" === b &&
                                    d.params.markersSelectable)) &&
                                (f.isDefaultPrevented() ||
                                    (d.params[b + "sSelectableOne"] &&
                                        d.clearSelected(b + "s"),
        ...
        bindZoomButtons: function () {
            ...
            jvm
                ...
                this.container.find(".jvectormap-zoomin").click(function () {
                    a.setScale(
                        a.scale * a.params.zoomStep,
                        a.width / 2,
                        a.height / 2,
                        !1,
                        a.params.zoomAnimate
                    );
                }),
        ...
        setScale: function (a, b, c, d, e) {
            var f,
                ...
                m,
                n,
                o = jvm.$.Event("zoom.jvectormap"),
                p = this,
                q = 0,
                r = Math.abs(
                    Math.round(
                        (60 * (a - this.scale)) / Math.max(a, this.scale)
                    )
                ),
                s = new jvm.$.Deferred();
            return (
                ...
                void 0 !== b &&
                    void 0 !== c &&
                    ((zoomStep = a / this.scale),
                    d
                        ? ((m =
                              b +
                              (this.defaultWidth *
                                  (this.width / (this.defaultWidth * a))) /
                                  2),
                          (n =
                              c +
                              (this.defaultHeight *
                                  (this.height / (this.defaultHeight * a))) /
                                  2))
                        : ((m = this.transX - ((zoomStep - 1) / a) * b),
                          (n = this.transY - ((zoomStep - 1) / a) * c))),
                e && r > 0
                    ? ((g = this.scale),
                      (h = (a - g) / r),
                      (i = this.transX * this.scale),
                      (k = this.transY * this.scale),
                      (j = (m * a - i) / r),
                      (l = (n * a - k) / r),
                      (f = setInterval(function () {
                          (q += 1),
                              (p.scale = g + h * q),
                              (p.transX = (i + j * q) / p.scale),
                              (p.transY = (k + l * q) / p.scale),
                              p.applyTransform(),
                              q == r &&
                                  (clearInterval(f),
                                  p.container.trigger(o, [a / p.baseScale]),
                                  s.resolve());
                      }, 10)))
                    : ((this.transX = m),
                      (this.transY = n),
                      (this.scale = a),
                      this.applyTransform(),
                      this.container.trigger(o, [a / this.baseScale]),
                      s.resolve()),
                s
            );
        },
        setFocus: function (a) {
            ...
            if (
                ((a = a || {}),
                a.region ? (e = [a.region]) : a.regions && (e = a.regions),
                e)
            ) {
                for (f = 0; f < e.length; f++)
                    this.regions[e[f]] &&
                        (c = this.regions[e[f]].element.shape.getBBox()) &&
                        (void 0 === b
                            ? (b = c)
                            : ((d = {
                                  x: Math.min(b.x, c.x),
                                  y: Math.min(b.y, c.y),
                                  width:
                                      Math.max(b.x + b.width, c.x + c.width) -
                                      Math.min(b.x, c.x),
                                  height:
                                      Math.max(b.y + b.height, c.y + c.height) -
                                      Math.min(b.y, c.y),
                              }),
                              (b = d)));
                return this.setScale(
                    Math.min(this.width / b.width, this.height / b.height),
                    -(b.x + b.width / 2),
                    -(b.y + b.height / 2),
                    !0,
                    a.animate
            ...
            return (
                a.lat && a.lng
                    ? ((g = this.latLngToPoint(a.lat, a.lng)),
                      (a.x = this.transX - g.x / this.scale),
                      (a.y = this.transY - g.y / this.scale))
                    : a.x &&
                      a.y &&
                      ((a.x *= -this.defaultWidth),
                      (a.y *= -this.defaultHeight)),
                this.setScale(a.scale * this.baseScale, a.x, a.y, !0, a.animate)
            );
        },
        ...
        setSelected: function (a, b) {
            ...
            if (("object" != typeof b && (b = [b]), jvm.$.isArray(b)))
                for (c = 0; c < b.length; c++)
                    this[a][b[c]].element.setSelected(!0);
            ...
            for (a in this.mapData.paths)
                (b = new jvm.Region({
                    ...
                    jvm.$(b.shape).bind("selected", function (a, b) {
                        c.container.trigger("regionSelected.jvectormap", [
        ...
        createMarkers: function (a) {
            ...
            if (
                ...
                for (f = a.slice(), a = {}, b = 0; b < f.length; b++)
                    a[b] = f[b];
            for (b in a)
                (e = a[b] instanceof Array ? { latLng: a[b] } : a[b]),
                    !1 !== (d = this.getMarkerPosition(e)) &&
                        ((c = new jvm.Marker({
                            map: this,
                            style: jvm.$.extend(
                                !0,
                        ...
                        jvm.$(c.shape).bind("selected", function (a, b) {
                            g.container.trigger("markerSelected.jvectormap", [
                                jvm.$(this.node).attr("data-index"),
                                b,
                                g.getSelectedMarkers(),
                            ]);
                        }),
                        this.markers[b] && this.removeMarkers([b]),
                        (this.markers[b] = { element: c, config: e }));
        },
        repositionMarkers: function () {
            var a, b;
            for (a in this.markers)
                !1 !== (b = this.getMarkerPosition(this.markers[a].config)) &&
                    this.markers[a].element.setStyle({ cx: b.x, cy: b.y });
        },
        repositionLabels: function () {
            var a;
            for (a in this.regions)
                this.regions[a].element.updateLabelPosition();
            for (a in this.markers)
                this.markers[a].element.updateLabelPosition();
        },
        getMarkerPosition: function (a) {
            return jvm.Map.maps[this.params.map].projection
                ? this.latLngToPoint.apply(this, a.latLng || [0, 0])
                : {
        ...
        addMarker: function (a, b, c) {
            var d,
                ...
                g = [],
                c = c || [];
            for (f[a] = b, e = 0; e < c.length; e++)
                (d = {}), void 0 !== c[e] && (d[a] = c[e]), g.push(d);
            this.addMarkers(f, g);
        },
        addMarkers: function (a, b) {
            var c;
            for (b = b || [], this.createMarkers(a), c = 0; c < b.length; c++)
                this.series.markers[c].setValues(b[c] || {});
        },
        removeMarkers: function (a) {
            var b;
            for (b = 0; b < a.length; b++)
                this.markers[a[b]].element.remove(), delete this.markers[a[b]];
        },
        ...
        latLngToPoint: function (a, b) {
            var c,
                d,
                e,
                f = jvm.Map.maps[this.params.map].projection,
                g = f.centralMeridian;
            return (
                -180 + g > b && (b += 360),
                (c = jvm.Proj[f.type](a, b, g)),
                !!(d = this.getInsetForPoint(c.x, c.y)) &&
                    ((e = d.bbox),
                    (c.x =
                        ((c.x - e[0].x) / (e[1].x - e[0].x)) *
                        d.width *
                        this.scale),
                    (c.y =
                        ((c.y - e[0].y) / (e[1].y - e[0].y)) *
                        d.height *
                        this.scale),
                    {
        ...
        pointToLatLng: function (a, b) {
            var c,
                ...
                f,
                g,
                h = jvm.Map.maps[this.params.map].projection,
                i = h.centralMeridian,
            ...
            for (c = 0; c < j.length; c++)
                if (
                    ((d = j[c]),
                    (e = d.bbox),
                    (f = a - (this.transX * this.scale + d.left * this.scale)),
                    (g = b - (this.transY * this.scale + d.top * this.scale)),
                    (f =
                        (f / (d.width * this.scale)) * (e[1].x - e[0].x) +
                        e[0].x),
                    (g =
                        (g / (d.height * this.scale)) * (e[1].y - e[0].y) +
                        e[0].y),
                    f > e[0].x && f < e[1].x && g > e[0].y && g < e[1].y)
                )
                    return jvm.Proj[h.type + "_inv"](f, -g, i);
            return !1;
        },
        getInsetForPoint: function (a, b) {
            var c,
                d,
                e = jvm.Map.maps[this.params.map].insets;
            for (c = 0; c < e.length; c++)
                if (
                    ((d = e[c].bbox),
                    a > d[0].x && a < d[1].x && b > d[0].y && b < d[1].y)
                )
                    return e[c];
        },
        createSeries: function () {
            ...
            for (b in this.params.series)
                for (a = 0; a < this.params.series[b].length; a++)
                    this.series[b][a] = new jvm.DataSeries(
                        this.params.series[b][a],
                        this[b],
                        this
                    );
        },
    ...
    (jvm.MultiMap = function (a) {
        var b = this;
        (this.maps = {}),
            (this.params = jvm.$.extend(!0, {}, jvm.MultiMap.defaultParams, a)),
    ...
    (jvm.MultiMap.prototype = {
        addMap: function (a, b) {
            var c = jvm.$("<div/>").css({ width: "100%", height: "100%" });
            return (
                this.params.container.append(c),
                (this.maps[a] = new jvm.Map(jvm.$.extend(b, { container: c }))),
                this.params.maxLevel > b.multiMapLevel &&
                    this.maps[a].container.on(
                        ...
                        function (a, b) {
                            ...
                            (c.drillDownPromise &&
                                "pending" === c.drillDownPromise.state()) ||
                                c.drillDown(d, b);
                        }
                    ),
                this.maps[a]
        ...
        downloadMap: function (a) {
            ...
            return (
                this.mapsLoaded[a]
                    ? c.resolve()
                    : jvm.$.get(this.params.mapUrlByCode(a, this)).then(
                          function () {
        ...
        drillDown: function (a, b) {
            var c = this.history[this.history.length - 1],
                d = this,
                e = c.setFocus({ region: b, animate: !0 }),
            ...
            e.then(function () {
                ...
                (this.drillDownPromise = jvm.$.when(f, e)),
                this.drillDownPromise.then(function () {
                    c.params.container.hide(),
                        d.maps[a]
                            ? d.maps[a].params.container.show()
                            : d.addMap(a, {
                                  map: a,
                                  multiMapLevel: c.params.multiMapLevel + 1,
                              }),
                        d.history.push(d.maps[a]),
                        d.backButton.show();
                });
        },
        goBack: function () {
            var a = this.history.pop(),
                ...
                c = this;
            a.setFocus({ scale: 1, x: 0.5, y: 0.5, animate: !0 }).then(
                function () {
                    a.params.container.hide(),
                        b.params.container.show(),
                        b.updateSize(),
                        1 === c.history.length && c.backButton.hide(),
                        b.setFocus({ scale: 1, x: 0.5, y: 0.5, animate: !0 });
                }
            );
        },
    }),
