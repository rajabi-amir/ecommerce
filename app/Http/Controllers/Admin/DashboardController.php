...
//  dd($successTransactionsChart , $unsuccessTransactionsChart);
        return view('admin.page.dashboard', compact(
             ...
             'success_transaction' ,'all_transaction',
                'notpay_order' ,'successpay_order',
                'all_order' ,
                'amunt_success_orders' ,'amunt_total_orders' ,'amunt_coupon_orders' ,'amunt_delivery_orders',
                'successsend_order' ,'returned_order',
                'month_visits', 'more',
